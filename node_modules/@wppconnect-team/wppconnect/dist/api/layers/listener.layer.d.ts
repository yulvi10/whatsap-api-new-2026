...
import { Ack, Chat, IncomingCall, LiveLocation, Message, ParticipantEvent, PresenceEvent, Wid } from '../model';
...
export declare class ListenerLayer extends ProfileLayer {
     ...
     * @returns Disposable object to stop the listening
     */
    onStreamModeChanged(callback: (mode: StreamMode) => void): {
        dispose: () => void;
    };
    /**
     ...
     * @returns Disposable object to stop the listening
     */
    onStreamInfoChanged(callback: (info: StreamInfo) => void): {
        dispose: () => void;
    };
    /**
     ...
     * @returns Disposable object to stop the listening
     */
    onBackendEvent(callback: (eventName: BackendEventName, ...args: any[]) => void): {
        dispose: () => void;
    };
    /**
     ...
     * @returns Disposable object to stop the listening
     */
    onNewChat(callback: (chat: Chat) => any): {
        dispose: () => void;
    };
}
