...
export declare let moduleRequire: (<T = any>(moduleId: string) => T) & {
    /**
     * module list
     */
    m: {
...
export declare function isReactComponent(moduleId: string): boolean;
/**
 ...
 *             full scan.
 */
export declare function searchId(condition: SearchModuleCondition, reverse?: boolean, hint?: string | RegExp): string | null;
/**
 ...
 * @param hint Optional name-token or regex to narrow the candidate set.
 */
export declare function search<T = any>(condition: SearchModuleCondition, reverse?: boolean, hint?: string | RegExp): T | null;
/**
 * Return the module from a search function
 * @param condition Function for compare the modules
 * @param reverse Search in reverse order
